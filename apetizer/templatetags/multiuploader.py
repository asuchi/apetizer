...
@register.simple_tag(takes_context=True)
def multiuploader_form(context, form_type="default", template="ui/multiuploader/form.html", target_form_fieldname=None,
...
@register.inclusion_tag('ui/multiuploader/noscript.html')
