...
# c.Session.username = u'biodigitals'
...
#c.NotebookNotary.db_file = u'signatures.db'
...
# for developpement settings on a local machine
#c.NotebookApp.tornado_settings = {
#    'headers': {
#        'Content-Security-Policy': "frame-ancestors 'http://localhost:8888' 'self' "
#   }
#}
...
# This allows adding javascript/css to be available from the notebook server
# machine, or overriding individual files in the IPython
c.NotebookApp.extra_static_paths = ['static']

# Extra paths to search for serving jinja templates.
# 
# Can be used to override templates from notebook.templates.
c.NotebookApp.extra_template_paths = ['templates']

#c = get_config()

# Python modules to load as notebook server extensions. This is an experimental
# API, and may change in future releases.
c.NotebookApp.server_extensions = ['apetizer.nbextension']